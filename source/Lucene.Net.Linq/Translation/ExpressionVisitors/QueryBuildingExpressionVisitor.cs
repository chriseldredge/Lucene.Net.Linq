...
namespace Lucene.Net.Linq.Translation.ExpressionVisitors
{
    internal class QueryBuildingExpressionVisitor : LuceneExpressionVisitor
    {
        private readonly IFieldMappingInfoProvider fieldMappingInfoProvider;
        private readonly Stack<Query> queries = new Stack<Query>();

        internal QueryBuildingExpressionVisitor(IFieldMappingInfoProvider fieldMappingInfoProvider)
        {
