...
{
    [TestFixture]
    public class MethodCallToLuceneQueryPredicateExpressionVisitorTests
    {
        private MethodCallToLuceneQueryPredicateExpressionVisitor visitor;
        ...
        public void SetUp()
        {
            visitor = new MethodCallToLuceneQueryPredicateExpressionVisitor();
